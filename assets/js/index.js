...
const animateHeader = gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({
  ...
  toggleClass: {
    className: "mos-header-scrolled",
    targets: ".mos-header"
  }
});

// hero animation timeline
const heroTimeLine = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  defaults: {
    ease: "expo.inOut",
    duration: 0.9
  }
...
document.addEventListener("DOMContentLoaded", () => {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(".mos-animate").forEach(element => {
    hideElement(element);
